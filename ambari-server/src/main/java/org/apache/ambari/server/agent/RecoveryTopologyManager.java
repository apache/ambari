...
/**
 * Tracks the server lifecycle and the agent sessions that supplied fresh component state.
 */
@Singleton
public class RecoveryTopologyManager {
  ...
  private final Map<Long, String> completeSnapshotSessions = new ConcurrentHashMap<>();
  ...
  public boolean isFresh(Long hostId) {
    ...
    return activeSession != null && activeSession.equals(completeSnapshotSessions.get(hostId));
  }
