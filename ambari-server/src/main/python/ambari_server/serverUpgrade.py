...
def set_current(options):
  pwd = os.getcwd()
  upper_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(pwd))))
  ambari_server_ut_result_path = os.path.join(upper_dir + "/ambari_server_ut_result.txt")
  sys.stdout = sys.stderr = open(ambari_server_ut_result_path, 'w')
