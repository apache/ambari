...
class Configurator:
    ...
    def getStackInformation(self):
        ...
        for service in services:
            ...
            serviceStructure.name = (
                service.getElementsByTagName("name")[0].childNodes[0].data
            )
            ...
            serviceStructure.user = (
                service.getElementsByTagName("user")[0].childNodes[0].data
            )
            ...
            for info in infos:
                for key in info.childNodes:
                    if key.nodeType == 1:
                        ...
                        repositoryStructure.info.addKey(
                            key.nodeName, key.childNodes[0].data
                        )
    ...
    def getConfiguration(self):
        ...
        coreSiteResultStructure.hadoopSecurityAuthentication = (
            hadoopSecurityAuthentication
        )
