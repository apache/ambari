...
CREATE TABLE scoped_workflow_state (
  ...
  CONSTRAINT PK_scoped_workflow_state PRIMARY KEY CLUSTERED (scope_key)
  );
...
CREATE TABLE service_dependency_binding (
  ...
  CONSTRAINT PK_service_dependency_binding PRIMARY KEY CLUSTERED (binding_id),
...
CREATE TABLE service_dependency_snapshot (
  ...
  security_policy_hash VARCHAR(71) NOT NULL, snapshot_json VARCHAR(MAX) NOT NULL,
  created_by_user_id INTEGER NOT NULL, create_timestamp BIGINT NOT NULL,
  CONSTRAINT PK_service_dependency_snapshot PRIMARY KEY CLUSTERED (binding_id, snapshot_version),
...
CREATE TABLE service_dependency_operation (
  ...
  CONSTRAINT PK_service_dependency_operation PRIMARY KEY CLUSTERED (operation_id),
...
CREATE TABLE service_dependency_deployment (
  ...
  plan_json VARCHAR(MAX) NOT NULL,
  progress_json VARCHAR(MAX) NOT NULL,
...
CREATE TABLE service_dependency_host_result (
  credential_plan_json VARCHAR(MAX),
  ...
  command_request_hash VARCHAR(71) NOT NULL, command_json VARCHAR(MAX) NOT NULL,
  ...
  result_json VARCHAR(MAX), result_hash VARCHAR(71), preparation_observation_id VARCHAR(36),
  ...
  CONSTRAINT PK_service_dependency_host_result PRIMARY KEY CLUSTERED (binding_id, snapshot_version, operation_epoch, host_id, dependency_type, check_kind),
...
CREATE TABLE service_dependency_fence (
  ...
  CONSTRAINT PK_service_dependency_fence PRIMARY KEY CLUSTERED (binding_id)
  );
...
CREATE TABLE board_payload (
  id BIGINT NOT NULL,
  payload VARCHAR(MAX) NOT NULL,
  CONSTRAINT PK_board_payload PRIMARY KEY CLUSTERED (id),
...
CREATE TABLE chart_share (
  ...
  create_at BIGINT NOT NULL DEFAULT 0,
  create_by VARCHAR(64) NOT NULL DEFAULT '',
  CONSTRAINT PK_chart_share PRIMARY KEY CLUSTERED (id));
