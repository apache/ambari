...
class AMBARI_METRICSServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendAmsConfigurationsFromBIGTOP302(configurations, clusterData, services, hosts)
...
class AMBARI_METRICSRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendAmsConfigurationsFromBIGTOP302(self, configurations, clusterData, services, hosts):
...
class AMBARI_METRICSValidator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("ams-hbase-site", self.validateAmsHbaseSiteConfigurationsFromBIGTOP30),
                       ("ams-hbase-env", self.validateAmsHbaseEnvConfigurationsFromBIGTOP30),
                       ("ams-site", self.validateAmsSiteConfigurationsFromBIGTOP30),
                       ("ams-env", self.validateAmsEnvConfigurationsFromBIGTOP30),
                       ("ams-grafana-env", self.validateGrafanaEnvConfigurationsFromBIGTOP30)]
  ...
  def validateAmsHbaseSiteConfigurationsFromBIGTOP30(self, properties, recommendedDefaults, configurations, services, hosts):
  ...
  def validateAmsHbaseEnvConfigurationsFromBIGTOP30(self, properties, recommendedDefaults, configurations, services, hosts):
  ...
  def validateAmsSiteConfigurationsFromBIGTOP30(self, properties, recommendedDefaults, configurations, services, hosts):
    validationItems = []
  ...
  def validateAmsEnvConfigurationsFromBIGTOP30(self, properties, recommendedDefaults, configurations, services, hosts):
  ...
  def validateGrafanaEnvConfigurationsFromBIGTOP30(self, properties, recommendedDefaults, configurations, services, hosts):
    validationItems = []
