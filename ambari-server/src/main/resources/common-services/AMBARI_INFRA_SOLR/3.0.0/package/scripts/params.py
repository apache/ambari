...
if "infra-solr-env" in config["configurations"]:
  ...
  zk_quorum = format(
    default(
      "configurations/infra-solr-env/infra_solr_zookeeper_quorum", zookeeper_quorum
    )
  )
...
infra_solr_role_ranger_admin = default(
  "configurations/infra-solr-security-json/infra_solr_role_ranger_admin", "ranger_user"
)
...
infra_solr_role_logsearch = default(
  "configurations/infra-solr-security-json/infra_solr_role_logsearch", "logsearch_user"
)
infra_solr_role_logfeeder = default(
  "configurations/infra-solr-security-json/infra_solr_role_logfeeder", "logfeeder_user"
)
