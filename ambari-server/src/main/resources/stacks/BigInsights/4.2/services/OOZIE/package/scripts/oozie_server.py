...
class OozieServer(Script):
  ...
  def get_stack_to_component(self):
    return {"BigInsights": "oozie-server"}
  ...
  def configure(self, env, upgrade_type=None):
    ...
    if upgrade_type == "nonrolling" and params.upgrade_direction == Direction.UPGRADE and \
            params.version and compare_versions(format_hdp_stack_version(params.version), '4.1.0.0') >= 0:
      ...
      iop_select.select("oozie-server", params.version)
