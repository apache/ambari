...
hive_version_lib = format('/usr/iop/{version}/hive/lib')
...
# Starting from IOP 4.1.0.0 drop should be executed with purge suffix
purge_tables = "false"
if Script.is_stack_greater_or_equal("4.1.0.0"):
  purge_tables = 'true'

  # this is NOT a typo.  IOP 4.1 configs for hcatalog/webhcat point to a
...
if hive_jdbc_driver == "com.microsoft.sqlserver.jdbc.SQLServerDriver":
  ...
  hive_previous_jdbc_jar_name = "sqljdbc4.jar" 
elif hive_jdbc_driver == "com.mysql.jdbc.Driver":
  jdbc_jar_name = "mysql-connector-java.jar"
  jdbc_symlink_name = "mysql-jdbc-driver.jar"
  hive_previous_jdbc_jar_name = "mysql-connector-java.jar"
elif hive_jdbc_driver == "org.postgresql.Driver":
  jdbc_jar_name = "postgresql-jdbc.jar"
  jdbc_symlink_name = "postgres-jdbc-driver.jar"
  hive_previous_jdbc_jar_name = "postgresql-jdbc.jar"  
elif hive_jdbc_driver == "oracle.jdbc.driver.OracleDriver":
  jdbc_jar_name = "ojdbc.jar"
  jdbc_symlink_name = "oracle-jdbc-driver.jar"
  hive_previous_jdbc_jar_name = "ojdbc.jar"  
  ...
  hive_previous_jdbc_jar_name = "sajdbc4.jar"
  sqla_db_used = True
