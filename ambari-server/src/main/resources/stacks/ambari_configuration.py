...
class AmbariSSODetails(object):
    ...
    def is_managing_services(self):
        ...
        return "true" == _get_from_dictionary(
            self.sso_properties, "ambari.sso.manage_services"
        )
    ...
    def get_services_to_enable(self):
        ...
        sso_enabled_services = _get_from_dictionary(
            self.sso_properties, "ambari.sso.enabled_services"
        )
    ...
    def should_enable_sso(self, service_name):
        ...
        if self.is_managing_services():
            ...
            return (
                "*" in services_to_enable or service_name.lower() in services_to_enable
            )
        else:
            return False
    ...
    def get_sso_provider_original_parameter_name(self):
        ...
        return _get_from_dictionary(
            self.sso_properties, "ambari.sso.provider.originalUrlParamName"
        )
    ...
    def get_sso_provider_certificate(
        ...
        public_cert = _get_from_dictionary(
            self.sso_properties, "ambari.sso.provider.certificate"
        )
        ...
        if public_cert:
            ...
            if include_header_and_footer:
                ...
                if public_cert.endswith(CERTIFICATE_FOOTER):
                    public_cert = public_cert[
                        : len(public_cert) - len(CERTIFICATE_FOOTER)
                    ]
...
class AmbariLDAPConfiguration:
    ...
    def is_ldap_enabled(self):
        return "true" == _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.authentication.enabled"
        )
    ...
    def get_server_host(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.connectivity.server.host"
        )
    ...
    def get_server_port(self):
        ...
        ldap_server_port = _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.connectivity.server.port"
        )
    ...
    def get_server_url(self):
        ...
        return (
            None
            if ldap_host is None or ldap_port is None
            else "{}:{}".format(ldap_host, ldap_port)
        )
    ...
    def get_secondary_server_host(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.connectivity.secondary.server.host"
        )
    ...
    def get_secondary_server_port(self):
        ...
        ldap_server_secondary_port = _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.connectivity.secondary.server.port"
        )
        return (
    ...
    def is_use_ssl(self):
        ...
        """
        return "true" == _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.connectivity.use_ssl"
        )
    ...
    def is_anonymous_bind(self):
        ...
        """
        return "true" == _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.connectivity.anonymous_bind"
        )
    ...
    def get_bind_dn(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.connectivity.bind_dn"
        )
    ...
    def get_bind_password(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.connectivity.bind_password"
        )
    ...
    def get_dn_attribute(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.attributes.dn_attr"
        )
    ...
    def get_user_object_class(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.attributes.user.object_class"
        )
    ...
    def get_user_name_attribute(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.attributes.user.name_attr"
        )
    ...
    def get_user_search_base(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.attributes.user.search_base"
        )
    ...
    def get_group_object_class(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.attributes.group.object_class"
        )
    ...
    def get_group_name_attribute(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.attributes.group.name_attr"
        )
    ...
    def get_group_member_attribute(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.attributes.group.member_attr"
        )
    ...
    def get_group_search_base(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.attributes.group.search_base"
        )
    ...
    def get_group_mapping_rules(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.group_mapping_rules"
        )
    ...
    def get_user_search_filter(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.user_search_filter"
        )
    ...
    def get_user_member_replace_pattern(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.user_member_replace_pattern"
        )
    ...
    def get_user_member_filter(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.user_member_filter"
        )
    ...
    def get_group_search_filter(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.group_search_filter"
        )
    ...
    def get_group_member_replace_pattern(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.group_member_replace_pattern"
        )
    ...
    def get_group_member_filter(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.group_member_filter"
        )
    ...
    def is_force_lower_case_user_names(self):
        ...
        """
        return "true" == _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.force_lowercase_usernames"
        )
    ...
    def is_pagination_enabled(self):
        ...
        """
        return "true" == _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.pagination_enabled"
        )
    ...
    def is_follow_referral_handling(self):
        ...
        """
        return "true" == _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.referrals"
        )
    ...
    def is_disable_endpoint_identification(self):
        ...
        """
        return "true" == _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.disable_endpoint_identification"
        )
    ...
    def is_ldap_alternate_user_search_enabled(self):
        ...
        """
        return "true" == _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.alternate_user_search_enabled"
        )
    ...
    def get_alternate_user_search_filter(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.alternate_user_search_filter"
        )
    ...
    def get_sync_collision_handling_behavior(self):
        ...
        """
        return _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.advanced.collision_behavior"
        )
    ...
    def is_managing_services(self):
        ...
        """
        return "true" == _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.manage_services"
        )
    ...
    def get_services_to_enable(self):
        ...
        ldap_enabled_services = _get_from_dictionary(
            self.ldap_properties, "ambari.ldap.enabled_services"
        )
