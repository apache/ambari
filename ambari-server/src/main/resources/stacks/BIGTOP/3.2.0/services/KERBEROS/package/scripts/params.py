...
if config is not None:
    ...
    if configurations is not None:
        ...
        if krb5_conf_data is not None:
            ...
            krb5_conf_dir = get_property_value(
                krb5_conf_data, "conf_dir", krb5_conf_dir
            )
            krb5_conf_file = get_property_value(
                krb5_conf_data, "conf_file", krb5_conf_file
            )
            krb5_conf_path = krb5_conf_dir + "/" + krb5_conf_file

            manage_krb5_conf = get_property_value(
                krb5_conf_data, "manage_krb5_conf", "true"
            )
        ...
        if kdc_conf_data is not None:
            ...
            kdc_conf_file = get_property_value(
                kdc_conf_data, "conf_file", kdc_conf_file
            )
            kdc_conf_path = kdc_conf_dir + "/" + kdc_conf_file
        ...
        if kadm5_acl_data is not None:
            ...
            kadm5_acl_dir = get_property_value(
                kadm5_acl_data, "conf_dir", kadm5_acl_dir
            )
            kadm5_acl_file = get_property_value(
                kadm5_acl_data, "conf_file", kadm5_acl_file
            )
            kadm5_acl_path = kadm5_acl_dir + "/" + kadm5_acl_file
