    ...
    def pre_upgrade_restart(self, env, upgrade_type=None):
        ...
        if (
            ...
            and check_stack_feature(
                StackFeature.HIVE_METASTORE_UPGRADE_SCHEMA,
    ...
    def upgrade_schema(self, env):
        ...
        if params.hive_jdbc_driver in params.hive_jdbc_drivers_list:
            ...
            if params.sqla_db_used:
                ...
                Execute(
                    format("{sudo} chown -R {hive_user}:{user_group} {hive_lib_dir}/*")
                )
            else:
        ...
        if not (
            check_stack_feature(StackFeature.CONFIG_VERSIONING, upgrade_from_version)
        ):
