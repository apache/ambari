...
def execute(configurations={}, parameters={}, host_name=None):
                ...
                try:
                    ...
                    if state == HDFS_NN_STATE_ACTIVE:
                        ...
                        nn_service_rpc_address_key = (
                            "dfs.namenode.servicerpc-address.{0}.{1}".format(
    ...
    metric_collector_https_enabled = (
        str(configurations[AMS_HTTP_POLICY]) == "HTTPS_ONLY"
    )
    ...
    if minimum_value_threshold:
        ...
        if len(metrics) < 2:
            return (
                RESULT_STATE_OK,
                [
                    "There were no data points above the minimum threshold of {0} seconds".format(
