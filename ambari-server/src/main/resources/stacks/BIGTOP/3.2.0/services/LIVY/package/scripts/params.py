        ...
        spark_hive_properties.update(
            {
                ...
                "hive.metastore.kerberos.keytab.file": config["configurations"][
                    "hive-site"
                ]["hive.metastore.kerberos.keytab.file"],
                "hive.server2.authentication.spnego.principal": config[
                    "configurations"
                ...
                "hive.metastore.kerberos.principal": config["configurations"][
                    "hive-site"
                ]["hive.metastore.kerberos.principal"],
                "hive.server2.authentication.kerberos.principal": config[
                    "configurations"
...
if spark_transport_mode.lower() == "binary":
    ...
    spark_thrift_endpoint = default(
        "configurations/spark-hive-site-override/hive.server2.http.endpoint",
        "cliservice",
    )
...
if is_hive_installed:
    ...
    spark_hive_properties.update(
        {
            "hive.metastore.client.socket.timeout": config["configurations"][
                "hive-site"
