...
class ZeppelinServiceAdvisor(service_advisor.ServiceAdvisor):
    ...
    def isKerberosEnabled(services, configurations):
        ...
        if (
            ...
            in configurations["zeppelin-env"]["properties"]
        ):
            return (
...
class ZeppelinRecommender(service_advisor.ServiceAdvisor):
    ...
    def recommendZeppelinConfigurationsFromHDP25(
        ...
        zeppelin_shiro_ini = self.getServicesSiteProperties(
            services, "zeppelin-shiro-ini"
        )
        ...
        if zeppelin_shiro_ini and "shiro_ini_content" in zeppelin_shiro_ini:
            ...
            if (
                ...
                if not "#cookie.secure = true" in shiro_ini_content:
                    ...
                    putZeppelinShiroIniProperty(
                        "shiro_ini_content", str(shiro_ini_content)
                    )
    ...
    def recommendZeppelinConfigurationsFromHDP30(
        ...
        if (
            ...
            and "spark2-atlas-application-properties-override"
            ...
            sac_enabled = (
                str(
                    services["configurations"][
                        "spark2-atlas-application-properties-override"
                    ]["properties"]["atlas.spark.enabled"]
                ).upper()
                == "TRUE"
            )
            zeppelin_env_properties = self.getServicesSiteProperties(
                services, "zeppelin-env"
            )
    ...
    def __recommendLivySuperUsers(self, configurations, services):
        ...
        if ZeppelinServiceAdvisor.isKerberosEnabled(services, configurations):
            ...
            if zeppelin_site and "zeppelin.server.kerberos.principal" in zeppelin_site:
                ...
                zeppelin_user = (
                    zeppelin_principal.split("@")[0] if zeppelin_principal else None
                )
