    ...
    if has_atlas_server:
        ...
        if len(atlas_notification_topics_list) == 2:
            ...
            if len(hook_policy_user) > 0:
                ...
                ranger_plugin_config["default-policy.1.policyItem.1.accessTypes"] = (
                    "publish"
                )
            ranger_plugin_config["default-policy.1.policyItem.2.users"] = atlas_user
            ranger_plugin_config["default-policy.1.policyItem.2.accessTypes"] = (
                "consume"
            )
            ...
            ranger_plugin_config["default-policy.2.policyItem.1.accessTypes"] = (
                "publish"
            )
            if has_ranger_tagsync:
                ranger_plugin_config["default-policy.2.policyItem.2.users"] = (
                    rangertagsync_user
                )
                ranger_plugin_config["default-policy.2.policyItem.2.accessTypes"] = (
                    "consume"
                )
