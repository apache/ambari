...
class AlluxioServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendAlluxioConfigurationsFromHDP33(configurations, clusterData, services, hosts)
...
class AlluxioRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendAlluxioConfigurationsFromHDP33(self, configurations, clusterData, services, hosts):
    """
