...
class RangerAdmin(Script):
        ...
        if (
            ...
            if (
                ...
                try:
                    ...
                    Logger.error(
                        "Error adding field to Ranger Audits Solr Collection. Kindly check Infra Solr service to be up and running {0}".format(
                            execution_exception
                        )
                    )
    ...
    def set_pre_start(self, env):
        ...
        Logger.info(
            "RANGER_ADMIN component will be stack-selected to version {0} using a {1} orchestration".format(
