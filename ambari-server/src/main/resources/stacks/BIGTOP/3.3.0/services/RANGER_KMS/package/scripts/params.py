...
if has_ranger_admin:
  ...
  driver_target = format("{kms_lib_path}/{jdbc_jar}") if stack_supports_ranger_audit_db else None
  xa_previous_jdbc_jar = format("{kms_lib_path}/{previous_jdbc_jar_name}") if stack_supports_ranger_audit_db else None
