...
class ADH11StackAdvisor(ADH10StackAdvisor):

  def getServiceConfigurationRecommenderDict(self):
    parentRecommendConfDict = super(ADH11StackAdvisor, self).getServiceConfigurationRecommenderDict()
  ...
  def getComponentLayoutSchemes(self):
    parentSchemes = super(ADH11StackAdvisor, self).getComponentLayoutSchemes()
    childSchemes = {
