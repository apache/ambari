...
with Environment() as env:
    ...
    def get_stack_version():
        if not options.hdp_version:
            ...
            with open(tmpfile.name, "r+") as file:
                get_stack_version_cmd = "/usr/bin/hdp-select status %s > %s" % (
    ...
    parser.add_option(
        ...
        default=get_value_from_properties(
            get_ambari_properties(), JDBC_DRIVER_PATH_PROPERTY, DEFAULT_SQL_DRIVER_PATH
        ),
    ...
    if not os.path.exists(options.sql_driver_path):
        Logger.error(
            "SQL driver file {} does not exist".format(options.sql_driver_path)
        )
    ...
    def getPropertyValueFromConfigXMLFile(xmlfile, name, defaultValue=None):
        ...
        propNodes = [
            ...
            if node.childNodes[0].nodeValue == name
        ]
        if len(propNodes) > 0:
    ...
    def get_fs_root(fsdefaultName=None):
        ...
        while True:
            fsdefaultName = getPropertyValueFromConfigXMLFile(
                "/etc/hadoop/conf/core-site.xml", "fs.defaultFS"
            )
            ...
            Logger.info(
                "Waiting to read appropriate value of fs.defaultFS from /etc/hadoop/conf/core-site.xml ..."
            )
            time.sleep(10)
    ...
    class params:
        ...
        oozie_setup_sh = format(
            "/usr/hdp/" + stack_version + "/oozie/bin/oozie-setup.sh"
        )
  ...
  """.format(stack_version)
    ...
    def createHdfsResources():
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/atshistory"),
            user="hdfs",
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/hcat"),
            owner="hcat",
            type="directory",
            action=["create_on_execute"],
            mode=0o755,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/hive/warehouse"),
            owner="hive",
            type="directory",
            action=["create_on_execute"],
            mode=0o777,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/warehouse/tablespace/external/hive"),
            owner="hive",
            type="directory",
            action=["create_on_execute"],
            mode=0o1777,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/hive"),
            owner="hive",
            type="directory",
            action=["create_on_execute"],
            mode=0o755,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/hive/.yarn/package/LLAP"),
            owner="hive",
            type="directory",
            action=["create_on_execute"],
            mode=0o755,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/ambari-qa"),
            type="directory",
            action=["create_on_execute"],
            mode=0o770,
        )
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/oozie"),
            owner="oozie",
            type="directory",
            action=["create_on_execute"],
            mode=0o775,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/app-logs"),
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/tmp/entity-file-history/active"),
            owner="yarn",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/mapred"),
            owner="mapred",
            type="directory",
            action=["create_on_execute"],
        )
        params.HdfsResource(
            format("{hdfs_path_prefix}/mapred/system"),
            owner="hdfs",
            type="directory",
            action=["create_on_execute"],
        )
        params.HdfsResource(
            format("{hdfs_path_prefix}/mr-history/done"),
            change_permissions_for_parents=True,
            owner="mapred",
            group="hadoop",
            type="directory",
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/yarn-ats"),
            owner="yarn-ats",
            type="directory",
            action=["create_on_execute"],
            mode=0o755,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/atshistory/done"),
            owner="yarn",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/atshistory/active"),
            owner="yarn",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/ams/hbase"),
            owner="ams",
            type="directory",
            action=["create_on_execute"],
            mode=0o775,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/amshbase/staging"),
            owner="ams",
            type="directory",
            action=["create_on_execute"],
            mode=0o711,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/ams/hbase"),
            owner="ams",
            type="directory",
            action=["create_on_execute"],
            mode=0o775,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/spark"),
            owner="spark",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/livy"),
            owner="livy",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/hdp/spark-events"),
            owner="spark",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/hdp/spark2-events"),
            owner="spark",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/hbase"),
            owner="hbase",
            type="directory",
            action=["create_on_execute"],
        )
        params.HdfsResource(
            format("{hdfs_path_prefix}/apps/hbase/staging"),
            owner="hbase",
            type="directory",
            action=["create_on_execute"],
            mode=0o711,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/hbase"),
            owner="hbase",
            type="directory",
            action=["create_on_execute"],
            mode=0o755,
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/apps/zeppelin"),
            owner="zeppelin",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/zeppelin"),
            owner="zeppelin",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
        ...
        params.HdfsResource(
            format("{hdfs_path_prefix}/user/zeppelin/test"),
            owner="zeppelin",
            group="hadoop",
            type="directory",
            action=["create_on_execute"],
    ...
    def copy_zeppelin_dependencies_to_hdfs(file_pattern):
        ...
        if spark_deps_full_path and os.path.exists(spark_deps_full_path[0]):
            copy_tarballs_to_hdfs(
                spark_deps_full_path[0],
                hdfs_path_prefix + "/apps/zeppelin/",
                params.hdfs_user,
                "zeppelin",
                "zeppelin",
            )
    ...
    def putSQLDriverToOozieShared():
        params.HdfsResource(
            ...
            action=["create_on_execute"],
            mode=0o644,
            source=options.sql_driver_path,
        )
    ...
    def create_yarn_service_tarball():
        ...
        folders = [
            params.yarn_home_dir,
            params.yarn_lib_dir,
            params.hdfs_home_dir,
            params.hdfs_lib_dir,
    ...
    configure_cmds.append(
        ("tar", "-xvf", oozie_home + "/oozie-sharelib.tar.gz", "-C", oozie_home)
    )
    configure_cmds.append(
        (
            "cp",
            "/usr/share/HDP-oozie/ext-2.2.zip",
            options.sql_driver_path,
            oozie_libext_dir,
        )
    )
    configure_cmds.append(
        (
            "chown",
            "oozie:hadoop",
            oozie_libext_dir + "/ext-2.2.zip",
            oozie_libext_dir + "/" + sql_driver_filename,
        )
    )
        ...
        if os.path.exists(spark_client_dir):
            try:
                ...
                if not os.path.exists(format("{oozie_shared_lib}/lib/spark")):
                    Execute(
                        ("mkdir", format("{oozie_shared_lib}/lib/spark")), sudo=True
                    )

                # Copy oozie-sharelib-spark from /usr/hdp/{stack_version}/oozie/share/lib/spark-orig to spark
                Execute(
                    format(
                        "cp -f {oozie_shared_lib}/lib/spark-orig/oozie-sharelib-spark*.jar {oozie_shared_lib}/lib/spark"
                    )
                )
                ...
                Execute(
                    format(
                        "cp -P {spark_client_dir}/lib/*.jar {oozie_shared_lib}/lib/spark"
                    )
                )
                Execute(format("find {oozie_shared_lib}/lib/spark/ -type l -delete"))
                try:
                    Execute(
                        format("rm -f {oozie_shared_lib}/lib/spark/spark-examples*.jar")
                    )
                except:
                    Logger.warning(
                        "No spark-examples jar files found in Spark client lib."
                    )

                # Copy /usr/hdp/{stack_version}/spark-client/python/lib/*.zip & *.jar to /usr/hdp/{stack_version}/oozie/share/lib/spark
                Execute(
                    format(
                        "cp -f {spark_client_dir}/python/lib/*.zip {oozie_shared_lib}/lib/spark"
                    )
                )
                ...
                try:
                    Execute(
                        format(
                            "cp -f {spark_client_dir}/python/lib/*.jar {oozie_shared_lib}/lib/spark"
                        )
                    )
                except:
                ...
                Execute(
                    ("chmod", "-R", "0755", format("{oozie_shared_lib}/lib/spark")),
                    sudo=True,
                )
                ...
                Logger.warning(
                    "Exception occurred while preparing oozie share lib: " + repr(e)
                )
    ...
    copy_tarballs_to_hdfs(
        format("/usr/hdp/{stack_version}/hadoop/mapreduce.tar.gz"),
    ...
    copy_tarballs_to_hdfs(
        format("/usr/hdp/{stack_version}/tez/lib/tez.tar.gz"),
    ...
    copy_tarballs_to_hdfs(
        format("/usr/hdp/{stack_version}/hive/hive.tar.gz"),
        hdfs_path_prefix + "/hdp/apps/{{ stack_version_formatted }}/hive/",
        params.mapred_user,
        params.hdfs_user,
        params.user_group,
    )
    ...
    copy_tarballs_to_hdfs(
        format("/usr/hdp/{stack_version}/tez_hive2/lib/tez.tar.gz"),
        hdfs_path_prefix + "/hdp/apps/{{ stack_version_formatted }}/tez_hive2/",
        params.mapred_user,
        params.hdfs_user,
        params.user_group,
    )
    ...
    copy_tarballs_to_hdfs(
        format("/usr/hdp/{stack_version}/pig/pig.tar.gz"),
    ...
    copy_tarballs_to_hdfs(
        format("/usr/hdp/{stack_version}/hadoop-mapreduce/hadoop-streaming.jar"),
        hdfs_path_prefix + "/hdp/apps/{{ stack_version_formatted }}/mapreduce/",
        params.mapred_user,
        params.hdfs_user,
        params.user_group,
    ...
    copy_tarballs_to_hdfs(
        format("/usr/hdp/{stack_version}/sqoop/sqoop.tar.gz"),
    ...
    createHdfsResources()
    copy_zeppelin_dependencies_to_hdfs(
        format(
            "/usr/hdp/{stack_version}/zeppelin/interpreter/spark/dep/zeppelin-spark-dependencies*.jar"
        )
    )
    ...
    File(
        format("{ambari_libs_dir}/fast-hdfs-resource.jar"),
        mode=0o644,
        content=StaticFile(
    ...
    if not options.upgrade:
        Logger.info(
            "Executing stack-selector-tool for stack {0} ...".format(stack_version)
        )
        Execute(("/usr/bin/hdp-select", "set", "all", stack_version), sudo=True)
