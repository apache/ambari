...
CREATE TABLE service_dependency_binding (
  binding_id VARCHAR(36) NOT NULL, consumer_cluster_id NUMERIC(19) NOT NULL,
  consumer_service_name VARCHAR(255) NOT NULL, provider_cluster_id NUMERIC(19) NOT NULL,
  provider_service_name VARCHAR(255) NOT NULL, dependency_type VARCHAR(32) NOT NULL,
  state VARCHAR(32) NOT NULL, provisioning_phase VARCHAR(64), row_version NUMERIC(19) NOT NULL,
  operation_epoch NUMERIC(19) NOT NULL, desired_snapshot_version NUMERIC(19) NOT NULL,
  snapshot_approval VARCHAR(32) NOT NULL, provider_preparation_hash VARCHAR(71),
  applied_snapshot_version NUMERIC(19), provider_fingerprint VARCHAR(71) NOT NULL,
  applied_provider_fingerprint VARCHAR(71), namespace_root VARCHAR(2048),
  namespace_wal VARCHAR(2048), namespace_znode VARCHAR(1024), action_host_id NUMERIC(19),
  active_operation_id VARCHAR(36) NOT NULL, active_request_id NUMERIC(19),
  ...
  updated_by_user_id INTEGER NOT NULL, create_timestamp NUMERIC(19) NOT NULL, update_timestamp NUMERIC(19) NOT NULL,
...
CREATE TABLE service_dependency_snapshot (
  binding_id VARCHAR(36) NOT NULL, snapshot_version NUMERIC(19) NOT NULL, schema_version INTEGER NOT NULL,
  ...
  security_policy_hash VARCHAR(71) NOT NULL, snapshot_json TEXT NOT NULL,
  created_by_user_id INTEGER NOT NULL, create_timestamp NUMERIC(19) NOT NULL,
...
CREATE TABLE service_dependency_operation (
  ...
  operation_kind VARCHAR(32) NOT NULL, operation_epoch NUMERIC(19) NOT NULL,
  target_snapshot_version NUMERIC(19) NOT NULL, request_hash VARCHAR(71) NOT NULL,
  state VARCHAR(32) NOT NULL, ambari_request_id NUMERIC(19), failure_code VARCHAR(128),
  failure_message VARCHAR(1024), create_timestamp NUMERIC(19) NOT NULL, update_timestamp NUMERIC(19) NOT NULL,
...
CREATE TABLE service_dependency_host_result (
  credential_plan_json TEXT,
  binding_id VARCHAR(36) NOT NULL, snapshot_version NUMERIC(19) NOT NULL, host_id NUMERIC(19) NOT NULL,
  dependency_type VARCHAR(32) NOT NULL, check_kind VARCHAR(64) NOT NULL,
  operation_epoch NUMERIC(19) NOT NULL, operation_id VARCHAR(36) NOT NULL, component_name VARCHAR(255),
  command_request_hash VARCHAR(71) NOT NULL, command_json TEXT NOT NULL,
  ambari_request_id NUMERIC(19), ambari_stage_id NUMERIC(19), ambari_task_id NUMERIC(19),
  ...
  result_json TEXT, result_hash VARCHAR(71), preparation_observation_id VARCHAR(36),
  ...
  state VARCHAR(32) NOT NULL, check_timestamp NUMERIC(19) NOT NULL, failure_code VARCHAR(128),
...
CREATE TABLE service_dependency_fence (
  binding_id VARCHAR(36) NOT NULL, final_epoch NUMERIC(19) NOT NULL,
  immutable_spec_hash VARCHAR(71) NOT NULL, dependency_type VARCHAR(32) NOT NULL,
  consumer_cluster_id NUMERIC(19) NOT NULL, consumer_service_name VARCHAR(255) NOT NULL,
  provider_cluster_id NUMERIC(19) NOT NULL, provider_service_name VARCHAR(255) NOT NULL,
  ...
  detach_timestamp NUMERIC(19) NOT NULL,
...
CREATE TABLE topology_request (
  ...
  repository_version_id NUMERIC(19),
