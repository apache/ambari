...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('ambari_configuration') AND type = 'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('kerberos_keytab') AND type = 'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_j_req_recovery')
BEGIN
create index idx_qrtz_j_req_recovery on qrtz_job_details(SCHED_NAME,REQUESTS_RECOVERY)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_j_grp')
BEGIN
create index idx_qrtz_j_grp on qrtz_job_details(SCHED_NAME,JOB_GROUP)
END


IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_j')
BEGIN
create index idx_qrtz_t_j on qrtz_triggers(SCHED_NAME,JOB_NAME,JOB_GROUP)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_jg')
BEGIN
create index idx_qrtz_t_jg on qrtz_triggers(SCHED_NAME,JOB_GROUP)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_c')
BEGIN
create index idx_qrtz_t_c on qrtz_triggers(SCHED_NAME,CALENDAR_NAME)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_g')
BEGIN
create index idx_qrtz_t_g on qrtz_triggers(SCHED_NAME,TRIGGER_GROUP)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_state')
BEGIN
create index idx_qrtz_t_state on qrtz_triggers(SCHED_NAME,TRIGGER_STATE)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_n_state')
BEGIN
create index idx_qrtz_t_n_state on qrtz_triggers(SCHED_NAME,TRIGGER_NAME,TRIGGER_GROUP,TRIGGER_STATE)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_n_g_state')
BEGIN
create index idx_qrtz_t_n_g_state on qrtz_triggers(SCHED_NAME,TRIGGER_GROUP,TRIGGER_STATE)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_next_fire_time')
BEGIN
create index idx_qrtz_t_next_fire_time on qrtz_triggers(SCHED_NAME,NEXT_FIRE_TIME)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_nft_st')
BEGIN
create index idx_qrtz_t_nft_st on qrtz_triggers(SCHED_NAME,TRIGGER_STATE,NEXT_FIRE_TIME)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_nft_misfire')
BEGIN
create index idx_qrtz_t_nft_misfire on qrtz_triggers(SCHED_NAME,MISFIRE_INSTR,NEXT_FIRE_TIME)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_nft_st_misfire')
BEGIN
create index idx_qrtz_t_nft_st_misfire on qrtz_triggers(SCHED_NAME,MISFIRE_INSTR,NEXT_FIRE_TIME,TRIGGER_STATE)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_t_nft_st_misfire_grp')
BEGIN
create index idx_qrtz_t_nft_st_misfire_grp on qrtz_triggers(SCHED_NAME,MISFIRE_INSTR,NEXT_FIRE_TIME,TRIGGER_GROUP,TRIGGER_STATE)
END


IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_ft_trig_inst_name')
BEGIN
create index idx_qrtz_ft_trig_inst_name on qrtz_fired_triggers(SCHED_NAME,INSTANCE_NAME)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_ft_inst_job_req_rcvry')
BEGIN
create index idx_qrtz_ft_inst_job_req_rcvry on qrtz_fired_triggers(SCHED_NAME,INSTANCE_NAME,REQUESTS_RECOVERY)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_ft_j_g')
BEGIN
create index idx_qrtz_ft_j_g on qrtz_fired_triggers(SCHED_NAME,JOB_NAME,JOB_GROUP)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_ft_jg')
BEGIN
create index idx_qrtz_ft_jg on qrtz_fired_triggers(SCHED_NAME,JOB_GROUP)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_ft_t_g')
BEGIN
create index idx_qrtz_ft_t_g on qrtz_fired_triggers(SCHED_NAME,TRIGGER_NAME,TRIGGER_GROUP)
END

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_qrtz_ft_tg')
BEGIN
