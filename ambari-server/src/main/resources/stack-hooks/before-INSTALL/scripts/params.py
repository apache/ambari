...
storm_server_hosts = execution_command.query_config_attri_directly("clusterHostInfo/nimbus_hosts", [])
falcon_host = execution_command.query_config_attri_directly("clusterHostInfo/falcon_server_hosts", [])
...
repo_file = execution_command.query_config_attri_directly("repositoryFile")
