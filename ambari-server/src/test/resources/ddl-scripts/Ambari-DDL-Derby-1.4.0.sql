...
select 'version','1.4.0' FROM SYSIBM.SYSDUMMY1;
...
CREATE TABLE workflow (
  ...
  duration BIGINT, workflowTags VARCHAR(20000),
...
CREATE TABLE application (
  appId VARCHAR(20000),
  workflowId VARCHAR(20000),
  appName VARCHAR(20000),
  workflowEntityName VARCHAR(20000),
  userName VARCHAR(20000), queue VARCHAR(20000),
  submitTime BIGINT, launchTime BIGINT, finishTime BIGINT,
  appType VARCHAR(20000),
  status VARCHAR(20000),
  appInfo VARCHAR(20000),
