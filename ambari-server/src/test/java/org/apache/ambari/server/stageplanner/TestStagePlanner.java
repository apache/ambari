...
public class TestStagePlanner {
  ...
  public void testManyStages() {
    ...
    stage.addHostRoleExecutionCommand("host7", Role.TEMPLETON_SERVER,
        RoleCommand.START, new ServiceComponentHostStartEvent("TEMPLETON_SERVER",
            "host7", now), "cluster1", "TEMPLETON");
