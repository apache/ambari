...
//    multiOozieSiteMap.put("hadoop.proxyuser.knox.hosts", new MultipleHostTopologyUpdater("KNOX_GATEWAY"));
  ...
  public void testAtlasHA() throws Exception {
    ...
    List<String> expected =
        Arrays.asList("c6401.ambari.apache.org:21000","c6402.ambari.apache.org:21000", "c6403.ambari.apache.org:21000");
  ...
  public void testAtlasHAEnableTLS() throws Exception {
    ...
    List<String> hostArray =
        Arrays.asList(atlasProperties.get("atlas.server.address.id1").split("\natlas.server.address.id.="));
    List<String> expected =
        Arrays.asList("c6401.ambari.apache.org:21443","c6402.ambari.apache.org:21443", "c6403.ambari.apache.org:21443");
