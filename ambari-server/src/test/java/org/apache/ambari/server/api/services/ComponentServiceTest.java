...
public class ComponentServiceTest extends BaseServiceTest {
  ...
  public List<ServiceTestInvocation> getTestInvocations() throws Exception {
    ...
    //getComponent
    ComponentService service = new TestComponentService("clusterName", "serviceGroupName", "serviceName", "componentName");
    ...
    //getComponents
    service = new TestComponentService("clusterName", "serviceGroupName", "serviceName", null);
    ...
    //createComponent
    service = new TestComponentService("clusterName", "serviceGroupName", "serviceName", "componentName");
  ...
  private class TestComponentService extends ComponentService {
    ...
    private TestComponentService(String clusterId, String serviceGroupId, String serviceId, String componentId) {
      super(clusterId, serviceGroupId, serviceId);
