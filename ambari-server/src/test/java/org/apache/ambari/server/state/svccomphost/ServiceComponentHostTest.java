...
public class ServiceComponentHostTest {
  ...
  public void setup() throws Exception {
    ...
    serviceGroup = serviceGroupFactory.createNew(clusters.getCluster(clusterName), "test_group", "HDP-2.0.6", new HashSet<>());
  ...
  public void testStaleConfigs() throws Exception {
    ...
    ServiceGroup customServiceGroup = serviceGroupFactory.createNew(clusters.getCluster(clusterName), "custom_group", "HDP-2.0.6", new HashSet<>());
