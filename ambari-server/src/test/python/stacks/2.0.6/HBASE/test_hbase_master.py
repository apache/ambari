...
class TestHBaseMaster(RMFTestCase):
  ...
  def test_decom_default(self):
    ...
    self.assertResourceCalled('Execute', ' HBASE_OPTS="$HBASE_OPTS " /usr/lib/hbase/bin/hbase --config /etc/hbase/conf org.jruby.Main /usr/lib/hbase/bin/region_mover.rb -m 1 unload host1',
                              logoutput = True,
                              user = 'hbase',
                              )
    ...
    self.assertResourceCalled('Execute', ' HBASE_OPTS="$HBASE_OPTS " /usr/lib/hbase/bin/hbase --config /etc/hbase/conf org.jruby.Main /usr/lib/hbase/bin/region_mover.rb -m 1 unload host2',
                              logoutput = True,
                              user = 'hbase',
                              )
    self.assertNoMoreResources()
  ...
  def test_decom_default_draining_only(self):
    ...
    self.assertResourceCalled('Execute', ' HBASE_OPTS="$HBASE_OPTS " /usr/lib/hbase/bin/hbase --config /etc/hbase/conf org.jruby.Main /usr/lib/hbase/bin/draining_servers.rb list'
                                         ' | grep host1 | xargs -r /usr/lib/hbase/bin/hbase --config /etc/hbase/conf org.jruby.Main /usr/lib/hbase/bin/draining_servers.rb remove',
                              logoutput = True,
                              user = 'hbase',
                              )
    self.assertNoMoreResources()
