...
class TestHawqMaster(RMFTestCase):
  ...
  HAWQ_CHECK_COMMAND = 'source /usr/local/hawq/greenplum_path.sh && hawq check -f /usr/local/hawq/etc/hawq_hosts --hadoop /usr/lib/hadoop --config /usr/local/hawq/etc/hawq_check.cnf '
