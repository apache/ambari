...
class TestSetupAgent(TestCase):
  ...
  @patch("ambari_commons.OSCheck.is_ubuntu_family")
  @patch.object(setup_agent, "findNearestAgentPackageVersion")
  def test_returned_optimal_version_is_initial_on_ubuntu(
    self,
    findNearestAgentPackageVersion_method,
    is_ubuntu_family_method,
    is_suse_family_method,
  ...
  @patch("ambari_commons.OSCheck.is_ubuntu_family")
  @patch.object(setup_agent, "findNearestAgentPackageVersion")
  def test_returned_optimal_version_is_nearest_on_suse(
    self,
    findNearestAgentPackageVersion_method,
    is_ubuntu_family_method,
    is_suse_family_method,
  ...
  @patch("ambari_commons.OSCheck.is_ubuntu_family")
  @patch.object(setup_agent, "findNearestAgentPackageVersion")
  def test_returned_optimal_version_is_nearest_on_ubuntu(
    self,
    findNearestAgentPackageVersion_method,
    is_ubuntu_family_method,
    is_suse_family_method,
  ...
  @patch("ambari_commons.OSCheck.is_ubuntu_family")
  @patch.object(setup_agent, "findNearestAgentPackageVersion")
  def test_returned_optimal_version_is_initial(
    self,
    findNearestAgentPackageVersion_method,
    is_ubuntu_family_method,
    is_suse_family_method,
  ...
  @patch("ambari_commons.OSCheck.is_ubuntu_family")
  @patch.object(setup_agent, "findNearestAgentPackageVersion")
  def test_returned_optimal_version_is_default(
    self,
    findNearestAgentPackageVersion_method,
    is_ubuntu_family_method,
    is_suse_family_method,
  ...
  def test_setup_agent_main(
    ...
    ret = setup_agent.main(
      ("setupAgent.py", "agents_host", "password", "server_hostname", "1.1.1", "8080")
    )
    ...
    getOptimalVersion_mock.reset_mock()
    ret = setup_agent.main(
      ("setupAgent.py", "agents_host", "password", "server_hostname", "null", "8080")
    )
    self.assertFalse(exit_mock.called)
    self.assertTrue(getOptimalVersion_mock.called)
    self.assertTrue("exitstatus" in ret)
    ...
    is_ubuntu_family_mock.return_value = False
    ret = setup_agent.main(
      ("setupAgent.py", "agents_host", "password", "server_hostname", "null", "null")
    )
    self.assertFalse(exit_mock.called)
    self.assertTrue("exitstatus" in ret)
    self.assertEqual(ret["exitstatus"], 0)
    ...
    self.assertTrue(isAgentPackageAlreadyInstalled_mock.called)
    self.assertFalse(
      installAgent_mock.called
    )  # ambari repo file is missing, so installAgent() will not be called
    self.assertFalse(is_suse_family_mock.called)
    self.assertFalse(is_ubuntu_family_mock.called)
    self.assertTrue("exitstatus" in ret)
    self.assertEqual(ret["exitstatus"], 2)  # ambari repo file not found error code
    self.assertTrue(
      get_ambari_repo_file_full_name_mock() in ret["log"]
    )  # ambari repo file not found message
    ...
    getOptimalVersion_mock.return_value = {
      "log": "",
      "exitstatus": 1,
    }  # ambari-agent not installed
    ret = setup_agent.main(
      ("setupAgent.py", "agents_host", "password", "server_hostname", "1.1.1", "8080")
    )
    self.assertFalse(exit_mock.called)
