...
class TestAmbariConfiguration(TestCase):
    ...
    def testNotEmtpyLDAPConfiguration(self):
        ...
        self.assertEqual(
            ambari_ldap_details.get_user_object_class(), "user.object_class"
        )
        self.assertEqual(
            ambari_ldap_details.get_user_name_attribute(), "user.name_attr"
        )
        self.assertEqual(ambari_ldap_details.get_user_search_base(), "user.search_base")
        self.assertEqual(
            ambari_ldap_details.get_group_object_class(), "group.object_class"
        )
        self.assertEqual(
            ambari_ldap_details.get_group_name_attribute(), "group.name_attr"
        )
        self.assertEqual(
            ambari_ldap_details.get_group_member_attribute(), "group.member_attr"
        )
        self.assertEqual(
            ambari_ldap_details.get_group_search_base(), "group.search_base"
        )
        self.assertEqual(
            ambari_ldap_details.get_group_mapping_rules(), "group_mapping_rules"
        )
        self.assertEqual(
            ambari_ldap_details.get_user_search_filter(), "user_search_filter"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ambari_ldap_details.get_user_member_filter(), "user_member_filter"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ambari_ldap_details.get_sync_collision_handling_behavior(),
            "collision_behavior",
        )
