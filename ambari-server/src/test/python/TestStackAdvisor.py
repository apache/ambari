...
class TestStackAdvisorInitialization(TestCase):
    ...
    def test_stackAdvisorLoadedForNotHDPStack(self):
        ...
        self.assertEqual(
            "-Xmx101m", yarn_configs["yarn.nodemanager.resource.memory-mb"]
        )
    ...
    def test_stackAdvisorDefaultImpl(self):
        ...
        self.assertEqual(
            "DefaultStackAdvisor", default_stack_advisor.__class__.__name__
        )
        services = {
        ...
        expectedRecommendLayoutResponse = {
            ...
            "recommendations": {
                ...
                "blueprint_cluster_binding": {
                    "host_groups": [
                        {"hosts": [{"fqdn": "host1"}], "name": "host-group-1"}
                    ]
                },
            },
            "hosts": ["host1"],
