    ...
    if (!errorTrans){
      if (target){
          if (target.isKillNode()){
            ...
            // var placeholder=this.factory.createPlaceholderNode(target,true);
            // this.addTransitionTo(placeholder,"error");
            this.addTransitionTo(target,"error");//TODO needs refactoring to do proper layout...
          }
      }
    }else{
