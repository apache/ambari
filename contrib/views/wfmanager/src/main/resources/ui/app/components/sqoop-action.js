...
export default Ember.Component.extend(EmberValidations,{
  ...
  validations : {
    ...
    //       return !object.get('actionModel.args') || object.get('actionModel.args').length === 0;
    //     },
    //     'message' : 'You need to provide a value for Command or Args'
    //   }
    // },
    // 'actionModel.args': {
    //   presence: {
    //     'if' : function(object, validator){
    //       return !object.get('actionModel.command');
    //     },
    //     'message' : 'You need to provide a value for Command or Args'
    //   }
    //  }
