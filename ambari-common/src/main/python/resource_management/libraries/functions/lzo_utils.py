...
def should_install_lzo():
  ...
  lzo_enabled = (
    io_compression_codecs is not None
    and "com.hadoop.compression.lzo" in io_compression_codecs.lower()
  )
...
def skip_package_operations():
  ...
  """
  return default("/ambariLevelParams/host_sys_prepped", False) and default(
    "/configurations/cluster-env/sysprep_skip_lzo_package_operations", False
  )
