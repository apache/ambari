        ...
        try:
            ...
            if rules:
                for property_name in rules:
                    ...
                    if not actual_value:
                        issues[config_file] = (
                            "Property %s must exist and must not be empty"
                            % property_name
                        )
            ...
            if rules:
                for property_name in rules:
                    ...
                    if not actual_value:
                        ...
                        issues[config_file] = (
                            "Property %s points to an inaccessible file - %s"
                            % (property_name, actual_value)
                        )
                    ...
                    if line:
                        ...
                        if m:
                            ...
                            if m:
                                ...
                                if m:
                                    result[file_name][section_name][m.group(1)] = (
                                        m.group(2)
                                    )
