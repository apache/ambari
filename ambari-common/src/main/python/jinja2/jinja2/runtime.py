...
def markup_join(seq):
    ...
    buf = []
    iterator = list(map(soft_unicode, seq))
    for arg in iterator:
        buf.append(arg)
...
def unicode_join(seq):
    ...
    return concat(list(map(str, seq)))
...
class Context(object):
    ...
    def __init__(self, environment, parent, name, blocks):
        ...
        # from the template.
        self.blocks = dict((k, [v]) for k, v in list(blocks.items()))
    ...
    def derived(self, locals=None):
        ...
        context.blocks.update((k, list(v)) for k, v in list(self.blocks.items()))
        return context
