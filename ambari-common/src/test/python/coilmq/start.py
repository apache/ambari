...
@click.option(
  "-b", "--host", help="Listen on specified address (default 127.0.0.1)", metavar="ADDR"
)
@click.option(
  "-p",
  "--port",
...
@click.option(
  "-d", "--daemon", default=False, help="Run server as a daemon (default False)."
)
@click.option(
