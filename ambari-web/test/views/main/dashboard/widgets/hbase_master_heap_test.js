...
describe('App.HBaseMasterHeapPieChartView', function () {

  var view;

  beforeEach(function () {
    view = App.HBaseMasterHeapPieChartView.create({
  ...
  describe('#getUsed()', function () {
    ...
    it('should return used memory value', function () {
      view.set('model.heapMemoryUsed', 100000);
  ...
  describe('#getMax()', function () {
    ...
    it('should return max memory value', function () {
      view.set('model.heapMemoryMax', 200000);
