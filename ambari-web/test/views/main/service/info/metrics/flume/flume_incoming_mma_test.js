...
describe('App.ChartServiceMetricsFlume_IncommingMMA', function () {
  ...
  describe('#colorForSeries', function () {
    ...
    it('should return #0066b3', function () {
      var seriesMock = {name: Em.I18n.t('services.service.info.metrics.flume.incoming_mma').format("avg")};
      view.colorForSeries(seriesMock);
      expect(view.colorForSeries(seriesMock)).to.be.equal('#0066b3');
    });

    it('should return #00CC00', function () {
      var seriesMock = {name: Em.I18n.t('services.service.info.metrics.flume.incoming_mma').format("min")};
      view.colorForSeries(seriesMock);
      expect(view.colorForSeries(seriesMock)).to.be.equal('#00CC00');
    });

    it('should return #FF8000', function () {
      var seriesMock = {name: Em.I18n.t('services.service.info.metrics.flume.incoming_mma').format("max")};
      view.colorForSeries(seriesMock);
