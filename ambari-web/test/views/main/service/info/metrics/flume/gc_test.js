...
describe('App.ChartServiceMetricsFlume_GarbageCollection', function () {

  var view;

  beforeEach(function () {
    view = App.ChartServiceMetricsFlume_GarbageCollection.create();
  });
  ...
  describe('#displayName', function () {
    it('should return name', function () {
      ...
      expect(view.seriesTemplate.displayName(name, hostName)).to.equal(
        Em.I18n.t('services.service.info.metrics.flume.hostName').format(hostName)
      );
    });
  });
