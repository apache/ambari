...
describe('App.ChartServiceMetricsFlume_SourceAcceptedCount', function () {

  var view;

  beforeEach(function () {
    view = App.ChartServiceMetricsFlume_SourceAcceptedCount.create();
  });
  ...
  describe('#displayName', function () {
    it('should return name', function () {
      ...
      expect(view.seriesTemplate.displayName(name, hostName)).to.equal(
        Em.I18n.t('services.service.info.metrics.flume.sourceName').format(name + ' (' + hostName + ')')
      );
    });
  });
