...
App.WizardStep1View = Em.View.extend({
  ...
  didInsertElement: function () {
    ...
    if (this.get('controller.selectedStack').get("showAvailable")) {
      ...
      var selected = this.get('controller.content.stacks').findProperty('id');
      if (selected) {
        // get back from other steps
  ...
  selectedPublicRepoVersion: function () {
    ...
    return this.get('controller.content.stacks').findProperty('id', selectedId);
