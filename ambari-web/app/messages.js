...
Em.I18n.translations = {
  ...
  'hostPopup.setSlotId.success': 'Updating slot id to \"{0}\". It may take a few moments for it to get refreshed.',
  'hostPopup.setSlotId.error': 'Updating the slot id failed.',
  'hostPopup.setSlotId.invalid': 'Should start with a forward slash it may include alphanumeric chars, dots, dashes and forward slashes.Should be less than 255 symbols.',
  'hostPopup.SlotId': 'Slot',
  ...
  'hosts.host.details.setSlotId':'Set Slot',
