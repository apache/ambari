...
Em.I18n.translations = {
  ...
  'admin.kerberos.wizard.step1.option.ds': 'Existing Apache Directory Server',
  'admin.kerberos.wizard.step1.option.ds.condition.1': 'Apache Directory Server secure LDAP (LDAPS) connectivity has been configured.',
  'admin.kerberos.wizard.step1.option.ds.condition.2': 'Apache Directory Server User container for principals has been created and is on-hand (e.g. OU=Hadoop,OU=People,dc=apache,dc=org)',
  'admin.kerberos.wizard.step1.option.ds.condition.3': 'Apache Directory Server administrative credentials with delegated control of “Create, delete, and manage user accounts” on the previously mentioned User container are on-hand.',
  'admin.kerberos.wizard.step1.option.ds.condition.4': 'The Java Cryptography Extensions (JCE) have been setup on the Ambari Server host and all hosts in the cluster.',
