...
App.AddHawqStandbyWizardStep3Controller = Em.Controller.extend({
  ...
  setDynamicConfigValues: function (configs, data) {
    var hawqStandbyHost = this.get('content.hawqHosts.newHawqStandby')
    var configProperties = configs.configs;
    configProperties.findProperty('name', 'hawq_standby_address_host').set('value', hawqStandbyHost).set('recommendedValue', hawqStandbyHost);
    return configs;
  },
