...
const messages: any = {
    ...
    'popup.dependent.configs.title.values': 'Ambari will update all checked configuration changes to the Recommended Value. Uncheck any configuration to retain the Current Value.',
    ...
    'admin.highAvailability.step4.ranger.save.configuration.note':'This configuration is created by Enable Ranger Admin HA wizard',
    'admin.highAvailability.step9.save.configuration.note':'This configuration is created by Enable NameNode HA wizard',
    ...
    'admin.nameNodeFederation.wizard.step4.task19.title': 'Restart Required Services',
    ...
    'admin.observerNameNode.closePopup2': 'Add Observer Namenode Wizard is in progress. You must allow the wizard to complete for Ambari to be in usable state. If you choose to quit, you must follow manual instructions to complete or revert Add Observer Namenode as documented in the Ambari User Guide. Are you sure you want to exit the wizard?',
    'admin.observerNameNode.wizard.required.zookeepers': 'All ZooKeeper Servers should be up',
    'admin.observerNameNode.wizard.required.journalnodes': 'All JournalNodes should be up',
    'admin.observerNameNode.wizard.step1.header': 'Get Started',
    'admin.observerNameNode.wizard.step1.body': 'This wizard will walk you through adding observer namenode on your cluster. Once enabled, you will be running a Observer Namenode in addition to your Active and Standby Namenode. This allows for an Active-Standby Namenode configuration that automatically performs failover.',
    'admin.observerNameNode.wizard.step1.alert': 'You should have atleast one Standby and one Active Namenode in your cluster',
    'admin.observerNameNode.wizard.step1.nameserviceid.existing': 'Existing Nameservice ID',
    'admin.observerNameNode.wizard.step1.nameserviceid': 'Please choose a Nameservice ID',
    'admin.observerNameNode.wizard.step1.nameserviceid.error': 'Must be one of the existing Nameservice',
    'admin.observerNameNode.wizard.step2.header': 'Select Hosts',
    'admin.observerNameNode.wizard.step2.body': 'Select hosts running the NameNodes for the observer.',
    'admin.observerNameNode.wizard.step3.confirm.host.body': 'Confirm your host selections.',
    ...
    'admin.observerNameNode.wizard.step4.save.configuration.note': 'This configuration is created by Add Observer Namenode wizard',
    'admin.observerNameNode.wizard.step4.notice.inProgress': 'Please wait while your Observer Namenode is being deployed.',
    'admin.observerNameNode.wizard.step4.notice.completed': 'Observer Namenode has been enabled successfully.',
    'admin.observerNameNode.wizard.step4.task0.title': 'Install Additional Namenode',
    ...
    'admin.observerNameNode.wizard.step4.task6.title': 'Bootstrap Additional Namenode',
    ...
    'admin.observerNameNode.wizard.step4.task11.title': 'Transition to Observer',
    ...
    'services.reassign.step4.tasks.stopSourceHostComponents.title':'Stop Source {0}',
    ...
    'hosts.bulkOperation.deleteHosts.dryRun.message':'The following {0} hosts could not be deleted (expand for reason):',
    ...
    'hosts.checkHost.popup':'Are you sure you want to Check host for {0}?',
    'hosts.passiveMode.popup':'Are you sure you want to Turn {0} Maintenance Mode for {1}?',
    ...
    'dashboard.widgets.RouterUp': 'Routers Live',
    ...
    'dashboard.services.hdfs.routers':'Routers',
    ...
    'dashboard.services.hbase.averageLoadPerServer':'regions per RegionServer',
    ...
    'dashboard.services.ranger.rangerTagsync':'Ranger Tagsync',
    ...
    'errorMessage.config.invalidValue': 'The value is not valid',
    ...
    // HiveServer2 Database Setup Messages
    'services.reassign.step3.hiveserver.database.setup.header': 'Database Setup Required',
    'services.reassign.step3.hiveserver.database.setup.message': 'Be sure you have run:',
    'services.reassign.step3.hiveserver.database.setup.command': 'ambari-server setup --jdbc-db=mysql --jdbc-driver=/path/to/mysql/mysql-connector-java.jar',
    'services.reassign.step3.hiveserver.database.setup.footer': 'on the Ambari Server host to make the JDBC driver available and to enable testing the database connection.'
