...
type YARNServiceData = Partial<ServiceData> & {
...
class YARNService extends Service {
  ...
  constructor(data: YARNServiceData) {
    ...
    this.nonActiveStandbyResourceManagers = data.nonActiveStandbyResourceManagers || [];
    this.isRMHAEnabled = data.isRMHAEnabled || false;
    this.yarnClients = data.yarnClients || 0;
