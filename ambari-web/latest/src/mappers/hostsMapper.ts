...
export const hostMapper = {
  hostConfig: {
    ...
    diskTotal: "metrics.disk.disk_total",
    diskFree: "metrics.disk.disk_free",
    ...
    loadOne: "metrics.load.load_one",
    loadFive: "metrics.load.load_five",
    loadFifteen: "metrics.load.load_fifteen",
    memTotal: "metrics.memory.mem_total",
    memFree: "metrics.memory.mem_free",
    cpuSystem: "metrics.cpu.cpu_system",
    cpuUser: "metrics.cpu.cpu_user",
