...
Em.I18n.translations = {
  ...
  'app.switchExperience':'Switch to latest UI',
  ...
  'workflow.persistence.idUnavailable': 'This browser cannot create a secure workflow identifier.',
  'workflow.persistence.scopeChanged': 'The workflow target changed before this operation completed.',
  'workflow.persistence.queuePaused': 'Reload the saved workflow before continuing.',
  'workflow.persistence.reentryRequired': 'Saved credentials were removed for safety. Re-enter the required values on the current wizard step before continuing.',
  'workflow.persistence.legacyUnverified': 'A previous wizard was found, but its user, workflow, and cluster identity could not all be verified.',
  'workflow.persistence.legacyOwnerMissing': 'Existing browser wizard data was preserved, but it cannot be assigned to this cluster without matching owner information.',
  'workflow.persistence.unsupported': 'This classic workflow has no scoped server persistence contract.',
  'workflow.persistence.active': 'Another workflow is already active for this cluster.',
  'workflow.persistence.signInCreate': 'Sign in before starting cluster creation.',
  'workflow.persistence.installerLegacyBlocked': 'An older cluster installation draft was preserved. Resume it from a verified recovery entry or clear it before starting another installation.',
  'workflow.persistence.signInLoad': 'Sign in before loading workflow state.',
  'workflow.persistence.principalChanged': 'The authenticated user changed while workflow state was loading.',
  'workflow.persistence.targetRequired': 'Classic wizard recovery requires exactly one authorized cluster. Choose a cluster in the current console to continue.',
  'workflow.persistence.stateUnavailable': 'No scoped workflow is available to reload.',
  'workflow.persistence.retryHeader': 'Reload Saved Workflow',
  'common.tags': 'Tags',
  ...
  'installer.step8.clusterNameCollision': 'A cluster named {0} already exists. Choose a different cluster name. Ambari did not modify the existing cluster.',
  'installer.step8.repositoryVersionConflict': 'Repository version {0} already exists with different repository settings. Choose the existing settings or another version. Ambari did not modify the shared definition.',
