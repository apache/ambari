...
// First ensure Ember is loaded
if (typeof Ember === 'undefined') {
  throw new Error('Ember must be loaded before app.js');
}
...
// Register injection for controllers
...
//     var controller = app[property].create();
//     // App.router.set(name, controller);
//   }
// });
