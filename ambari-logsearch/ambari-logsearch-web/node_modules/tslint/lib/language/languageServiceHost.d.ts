...
export declare function wrapProgram(program: ts.Program): ts.LanguageService;
export declare function checkEdit(ls: ts.LanguageService, sf: ts.SourceFile, newText: string): ts.Diagnostic[];
