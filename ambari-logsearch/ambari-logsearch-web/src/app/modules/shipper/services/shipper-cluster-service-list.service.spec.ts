...
import { ShipperClusterServiceListService } from './shipper-cluster-service-list.service';
...
describe('ShipperClusterServiceListService', () => {
  beforeEach(() => {
  ...
  it('should be created', inject([ShipperClusterServiceListService], (service: ShipperClusterServiceListService) => {
