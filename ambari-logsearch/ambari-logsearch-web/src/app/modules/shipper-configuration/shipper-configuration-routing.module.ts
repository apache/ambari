...
const shipperConfigurationRoutes: Routes = [{
  path: 'shipper',
  component: ShipperConfigurationListComponent,
  ...
  children: [{
    ...
    children: [{
      path: ':serviceName',
      component: ShipperConfigurationFormComponent
    }]
  }]
}];
...
@NgModule({
  imports: [
    RouterModule.forChild(shipperConfigurationRoutes)
  ],
  exports: [
    RouterModule
  ]
})
export class ShipperConfigurationRoutingModule { }
