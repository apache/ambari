...
class TestExecuteResource(TestCase):
    ...
    def test_attribute_logoutput(
        self, popen_mock, info_mock, select_mock, os_read_mock
    ):
    ...
    def test_attribute_wait(self, popen_mock, proc_communicate_mock):
        ...
        self.assertFalse(
            proc_communicate_mock.called,
            "proc.communicate should not have been called!",
        )
    ...
    @patch.object(select, "select")
    @patch.object(subprocess, "Popen")
    def test_attribute_environment_non_root(
