...
class TestXmlConfigResource(TestCase):
  ...
  def test_action_create_empty_xml_config(
    self,
    time_asctime_mock,
    os_path_isdir_mock,
    os_path_exists_mock,
    ...
    with Environment("/") as env:
      XmlConfig(
        "file.xml", conf_dir="/dir/conf", configurations={}, configuration_attributes={}
      )
  ...
  @patch("resource_management.core.sudo.path_isdir")
  @patch.object(time, "asctime")
  def test_action_create_simple_xml_config(
    self,
    time_asctime_mock,
    os_path_isdir_mock,
    os_path_exists_mock,
  ...
  @patch("resource_management.core.sudo.path_isdir")
  @patch.object(time, "asctime")
  def test_action_create_simple_xml_config_with_inclusion(
    self,
    time_asctime_mock,
    os_path_isdir_mock,
    os_path_exists_mock,
    ...
    with Environment("/") as env:
      XmlConfig(
        ...
        configuration_attributes={
          ...
          "attr2": {"prop.4": "value4", "prop.3": "value3"},
          "attr_empty": {},
  ...
  @patch("resource_management.core.sudo.path_isdir")
  @patch.object(time, "asctime")
  def test_action_create_xml_config_sorted_by_key(
    self,
    time_asctime_mock,
    os_path_isdir_mock,
    os_path_exists_mock,
  ...
  @patch("resource_management.core.sudo.path_exists")
  @patch("resource_management.core.sudo.path_isdir")
  def test_action_create_arguments(
    self, os_path_isdir_mock, os_path_exists_mock, file_mock
  ):
    os_path_isdir_mock.side_effect = [False, True]
    os_path_exists_mock.return_value = False
    ...
    self.assertEqual(
      call_args, {"owner": "hdfs", "group": "hadoop", "mode": 0o755, "encoding": "Code"}
    )
