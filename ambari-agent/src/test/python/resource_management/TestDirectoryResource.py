...
class TestDirectoryResource(TestCase):
    ...
    def test_create_directory_recursive(
        ...
        os_stat_mock.return_value = type(
            "", (), dict(st_mode=0o755, st_uid=0, st_gid=0)
        )()
    ...
    def test_create_directory_not_recursive(
        ...
        with Environment("/") as env:
            Directory(
                "/a/b/c/d", action="create", mode=0o777, owner="hdfs", group="hadoop"
            )
    ...
    @patch("resource_management.core.sudo.path_exists")
    @patch("resource_management.core.sudo.path_isdir")
    def test_create_directory_path_is_file_or_line(
        self, isdir_mock, os_path_exists_mock
    ):
        ...
        try:
            ...
            self.assertEqual(
                "Applying Directory['/a/b/c/d'] failed, file /a/b/c/d already exists",
                str(e),
            )
    ...
    def test_delete_directory_with_path_to_file(
        ...
        try:
            ...
            self.assertEqual(
                "Applying Directory['/a/b/c/d'] failed, /a/b/c/d is not a directory",
                str(e),
            )
