...
class TestActionQueue(TestCase):
    ...
    def test_auto_execute_command(self):
        ...
        initializer_module.recovery_manager.update_config(
            5, 5, 1, 11, True, False, False
        )
    ...
    def test_execute_command(self):
        ...
        with patch("builtins.open") as open_mock:
            ...
            expected = {
                ...
                "structuredOut": "Read from {0}".format(
    ...
    def test_hide_passwords_no_matching_password(self):
        ...
        self.assertEqual(
            hide_passwords("No 'password' 'in' this text'"),
            "No 'password' 'in' this text'",
        )
        self.assertEqual(
            hide_passwords("No 'password': in this text"), "No 'password': in this text"
        )
    ...
    def test_hide_passwords(self):
        ...
        self.assertEqual(
            hide_passwords(
                "'some.password': 'password', 'other.password': 'password',"
            ),
