...
class AmbariConfig:
    ...
    def __init__(self):
        ...
        self._stacks_dir = os.path.join(
            self.cache_dir, FileCache.STACKS_CACHE_DIRECTORY
        )
    ...
    def get_resolved_config(cls, home_dir=""):
        ...
        try:
            if os.path.exists(configPath):
                ...
                raise Exception(
                    "No config found at {0}, use default".format(configPath)
                )
    ...
    def getConfigFile(home_dir=""):
        ...
        if "AMBARI_AGENT_CONF_DIR" in os.environ:
            ...
            return os.path.join(
                os.sep, home_dir, "etc", "ambari-agent", "conf", "ambari-agent.ini"
            )
    ...
    def getLogFile(home_dir=""):
        ...
        if "AMBARI_AGENT_LOG_DIR" in os.environ:
            ...
            return os.path.join(
                os.sep, home_dir, "var", "log", "ambari-agent", "ambari-agent.log"
            )
    ...
    def getAlertsLogFile(home_dir=""):
        ...
        if "AMBARI_AGENT_LOG_DIR" in os.environ:
            ...
            return os.path.join(
                os.sep, home_dir, "var", "log", "ambari-agent", "ambari-alerts.log"
            )
    ...
    def getOutFile(home_dir=""):
        ...
        if "AMBARI_AGENT_LOG_DIR" in os.environ:
            ...
            return os.path.join(
                os.sep, home_dir, "var", "log", "ambari-agent", "ambari-agent.out"
            )
    ...
    def use_system_proxy_setting(self):
        ...
        """
        return (
            "true" == self.get("network", "use_system_proxy_settings", "true").lower()
        )
